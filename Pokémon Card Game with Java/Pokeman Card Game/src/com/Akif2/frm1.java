...
public class frm1 extends javax.swing.JFrame {
    ...
    private static String gameType2;
    public frm1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    final String[] gametype = { "Player & Computer","Computer & Computer" };
                    ...
                    if(gameType == null)
			System.exit(0);
                    if (gameType.equals("Player & Computer")) {
                        new computerVSuser().setVisible(false);
                        
                    }
                    else
                        new computerVsComputer().setVisible(false);
		} catch (Exception e) {
                    e.printStackTrace();
		}
            }

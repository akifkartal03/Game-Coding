 ...
 * @author AKIF
 */
public class computerVsComputer extends javax.swing.JFrame {
    ...
    */
     ...
     */
    public computerVsComputer() throws IOException {
        initComponents();
        initComponents2();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Choose Computer2 Card");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 523, 214, 31));
        ...
        jButton7.setText("Choose Computer1 Card");
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/Akif2/img/pn.png"))); // NOI18N
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 523, 200, 31));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        machine1.getCard(cards, first);
        cards.removeAll(machine1.getCards());
    ...
    private boolean getGameOver(){
        if (machine.getSize()==0&&machine1.getSize()==0) {
            return true;
        }
        else
            return false;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        Pokemon userCard = machine1.chooseCard("default");
        ...
        if (isThereCard()) {
           jButton4.setVisible(true);       
            ...
            if (getGameOver()) {
                ...
                String winner;
                if (machine.showScore()>machine1.showScore()) {
                    winner = "Computer2";
                }
                else if (machine.showScore()<machine1.showScore()) {
                    winner = "Computer1";
                }
                else
                    winner = "No winner";
